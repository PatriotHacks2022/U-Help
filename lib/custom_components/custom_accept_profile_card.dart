...
class CustomAcceptProfileCard extends StatefulWidget {
  ...
  @override
  State<CustomAcceptProfileCard> createState() {
    return _CustomAcceptProfileCardState();
  }
}

class _CustomAcceptProfileCardState extends State<CustomAcceptProfileCard> {
