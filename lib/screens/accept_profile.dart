...
class AcceptProfilePage extends StatefulWidget {

  const AcceptProfilePage({Key? key, required this.personData}) : super(key: key);

  final PersonData personData;

  @override
  _AcceptProfilePageState createState() => _AcceptProfilePageState();
}

class _AcceptProfilePageState extends State<AcceptProfilePage> {
  @override
